    ...
    <div className="flex items-center space-x-2">
      ...
      {spotifyConnected ? (
        <>
          ...
          <button
            className="ml-2 text-xs px-2 py-0.5 rounded border border-[#1DB954] text-[#1DB954] hover:bg-[#1DB954]/10 focus:ring-[#1DB954] font-semibold"
        ...
        <button
          className="ml-2 border-[#1DB954] text-[#1DB954] hover:bg-[#1DB954]/10 focus:ring-[#1DB954] font-semibold text-xs px-2 py-0.5 rounded border"
          onClick={onConnect}
          disabled={loading}
          style={{ minWidth: 70 }}
        >
